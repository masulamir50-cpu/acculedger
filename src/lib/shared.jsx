...
export const T = {
  ...
  accent3:  "#a8853d",
  cyan:     "#22c55e",
  cyanDim:  "rgba(34,197,94,0.08)",
  violet:   "#3b82f6",
  violetDim:"rgba(59,130,246,0.08)",
  text:     "#ffffff",
  textMid:  "#a0a0a0",
  muted:    "#555555",
  green:    "#22c55e",
  ...
  shadowLg:   "0 8px 32px rgba(0,0,0,0.95)",
  shadowGold: "0 0 16px rgba(201,168,76,0.15)",
  shadowCyan: "0 0 16px rgba(34,197,94,0.1)",
  gradAccent: "linear-gradient(135deg, #d4b96a, #c9a84c, #a8853d)",
  gradCyan:   "linear-gradient(135deg, #22c55e, #16a34a)",
  gradDark:   "linear-gradient(135deg, #111111, #0a0a0a)",
  gradHero:   "linear-gradient(135deg, #0a0a0a, #111111)",
  blur: "blur(0px)",
};
